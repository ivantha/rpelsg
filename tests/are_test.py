...
def are_test(datasets):
    ...
    memory_profiles = (
        ...
        # (MemoryProfile.alpha_100, Alpha(edge_lists[0], w=80, d=7)),
        # (MemoryProfile.alpha_200, Alpha(edge_lists[0], w=113, d=7)),
        # (MemoryProfile.alpha_300, Alpha(edge_lists[0], w=139, d=7)),
        # (MemoryProfile.alpha_400, Alpha(edge_lists[0], w=160, d=7)),
        # (MemoryProfile.alpha_512, Alpha(edge_lists[0], w=181, d=7)),
        # (MemoryProfile.alpha_1024, Alpha(edge_lists[0], w=256, d=7)),
        # (MemoryProfile.alpha_2048, Alpha(edge_lists[0], w=362, d=7)),
        # (MemoryProfile.alpha_4096, Alpha(edge_lists[0], w=512, d=7)),
        # (MemoryProfile.alpha_8192, Alpha(edge_lists[0], w=724, d=7)),
        # (MemoryProfile.alpha_16384, Alpha(edge_lists[0], w=1024, d=7)),
        # (MemoryProfile.alpha_32768, Alpha(edge_lists[0], w=1448, d=7)),
        # (MemoryProfile.alpha_65536, Alpha(edge_lists[0], w=2048, d=7)),
    )
